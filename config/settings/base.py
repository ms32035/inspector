...
)  # (inspector/config/settings/base.py - 3 = inspector/)
...
MIGRATION_MODULES = {"sites": "inspector.contrib.sites.migrations"}
...
LOGIN_REDIRECT_URL = "checks:datacheck_status"
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "inspector.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "inspector.users.adapters.SocialAccountAdapter"
